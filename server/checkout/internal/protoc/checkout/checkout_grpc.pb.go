...
const (
	Checkout_AddToCart_FullMethodName      = "/proto.Checkout/AddToCart"
	Checkout_DeleteFromCart_FullMethodName = "/proto.Checkout/DeleteFromCart"
	Checkout_ListCart_FullMethodName       = "/proto.Checkout/ListCart"
	Checkout_Purchase_FullMethodName       = "/proto.Checkout/Purchase"
)
...
func (c *checkoutClient) AddToCart(ctx context.Context, in *AddToCartRequest, opts ...grpc.CallOption) (*AddToCartResponse, error) {
...
func (c *checkoutClient) DeleteFromCart(ctx context.Context, in *DeleteFromCartRequest, opts ...grpc.CallOption) (*DeleteFromCartResponse, error) {
...
func (UnimplementedCheckoutServer) AddToCart(context.Context, *AddToCartRequest) (*AddToCartResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddToCart not implemented")
}
func (UnimplementedCheckoutServer) DeleteFromCart(context.Context, *DeleteFromCartRequest) (*DeleteFromCartResponse, error) {
