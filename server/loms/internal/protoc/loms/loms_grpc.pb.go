...
func (c *lomsClient) OrderPayed(ctx context.Context, in *OrderPayedRequest, opts ...grpc.CallOption) (*OrderPayedResponse, error) {
...
func (UnimplementedLomsServer) OrderPayed(context.Context, *OrderPayedRequest) (*OrderPayedResponse, error) {
